...
### Clonig the Project
           ...
           2) In CMD Open the folder where you want to clone the Project 
...
### Running the Project 
	   ...
	   Note : for react-native app make sure Project is opened in Android Studio 
           
           1) Open the cloned repository folder through the cmd 
               Enter the following commands 
               cd /foldername 
               Ex: cd /MyApp Then enter 
